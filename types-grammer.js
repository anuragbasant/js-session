...
console.log('index of value 3 is->', arr.indexOf(3), ' legth of arr is->', arr.length);
arr.push(6);
...
console.log('new lenght', arr.concat([6, 7, 8]));
...
// array.include() -> check if given elem present or not
var arr = [1, 2, 3];
console.log(arr.includes(2));


// arr.some -> The some() method tests whether at least one element in the array passes the test implemented by the provided function. It returns a Boolean value. 
...
var twoTimesArr = arr.map(value => value * 2);

console.log(twoTimesArr);
console.log(arr);


// flat, flatmap, join, keys, values, reduce, reverse
...
// reduce -> return 1 value // arr.reduce(callbackFn, initialValue)
var arr = [1, 2, 3];
